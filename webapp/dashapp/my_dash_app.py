...
def Add_Dash(server): 
    dashapp = dash.Dash(__name__, server=server, routes_pathname_prefix='/dash/', external_stylesheets=[dbc.themes.BOOTSTRAP])
    ...
    layout1 = html.Div([navbar, body1_admin])    
    layout2 = html.Div([navbar, body2_admin])    
    #/END_DASH_LAYOUT-----------------------------------------------------------------------------------------------
